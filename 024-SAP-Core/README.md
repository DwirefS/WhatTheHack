# Welcome to the SAP on Azure Core Hack!
# What The Hack - SAP on Azure Core

This is a challenge-based hack for scenarios that showcase SAP on Azure deployment foundation and best practices. This SAP-Core challenge focuses on 
